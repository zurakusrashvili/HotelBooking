        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AvailableDates_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.InsertData(
                table: "Rooms",
                columns: new[] { "Id", "Available", "HotelId", "MaximumGuests", "Name", "PricePerNight" },
                values: new object[,]
                {
                    { 1, true, 1, 3, "Premium Room", 10 },
                    { 2, true, 1, 3, "Deluxe Twin Room", 100 },
                    { 3, true, 1, 2, "Club Room", 100 },
                    { 4, true, 1, 3, "Deluxe Double Room", 10 },
                    { 5, true, 1, 3, "Junior Suite", 10 },
                    { 6, true, 1, 2, "Club Twin Room", 10 },
                    { 7, true, 1, 3, "Grand Deluxe Suite", 10 },
                    { 8, true, 1, 5, "Executive Suite", 10 },
                    { 9, true, 2, 3, "Superior Twin Room", 10 },
                    { 10, true, 2, 3, "Junior Suite", 10 },
                    { 11, true, 2, 3, "Superior Room", 10 },
                    { 12, true, 2, 3, "Executive Room", 10 },
                    { 13, true, 2, 3, "Deluxe Twin Room", 10 },
                    { 14, true, 2, 3, "Deluxe Room", 10 },
                    { 15, true, 3, 3, "Premium Room", 10 },
                    { 16, true, 3, 3, "Superior Room", 10 },
                    { 17, true, 3, 3, "Superior Room, City View (High Floor)", 10 },
                    { 18, true, 3, 3, "Standard Room", 10 },
                    { 19, true, 3, 4, "Junior Suite", 10 },
                    { 20, true, 3, 2, "Premium Room", 10 }
                });
